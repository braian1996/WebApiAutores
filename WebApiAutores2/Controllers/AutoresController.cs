...
{
    [ApiController]
    [Route("api/autores")] // api/autores => ruta de este controlador 
    public class AutoresController : ControllerBase
    {
        ...
        [HttpGet("{nombre}")] // no lleva restricciones NO nombre:string SOLO nombre(en este caso)
        ...
        {
            var existeAutorConeElMismoNombre = await context.Autores.AnyAsync(x => x.Nombre == autorCreacionDTO.Nombre);
